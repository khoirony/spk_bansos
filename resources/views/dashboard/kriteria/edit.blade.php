    ...
    <form action="/updatekriteria/{{ $kriteria->id }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select"  id="atribut_kriteria" name="atribut_kriteria">
                <option value="{{$kriteria->atribut_kriteria}}">{{$kriteria->atribut_kriteria}}</option>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="bobot_kriteria" name="bobot_kriteria" placeholder="1-5" value="{{$kriteria->bobot_kriteria}}">
        </div>
